    ...
    return (
        <div className='bg-teal-900 flex z-[-2] items-center justify-center text-white font-poppins'>
            <div className='w-full flex flex-col items-center justify-center md:w-[80%] lg:w-[40%]' >
                <div className={`w-full grid grid-cols-2 py-7 bg-teal-950`} style={{backgroundImage: `url(${MainBg})`, }}>
                    {
                        ...
                        <Link to={item.link}>
                            ...
                            gap-5 sm:gap-10 md:gap-5 lg:gap-8 px-10' onClick={item.action}>
                                ...
                                <span className='z-4'>{item.icon}</span> <img src={IconBg} className='mt-[-120px] sm:mt-[-150px] md:mt-[-200px] lg:mt-[-110px] w-45 sm:w-55 md:w-80 lg:w-35'/></li>
                                <p className='text-lg cursor-pointer font-semibold mb-15 sm:mb-20 md:mb-35 lg:mb-15'>{item.text}</p>
                            </div>
