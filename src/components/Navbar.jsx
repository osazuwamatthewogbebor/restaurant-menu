...
const Navbar = () => {
    ...
    return (
        <div className='bg-teal-900 flex justify-center items-center font-poppins'>
            ...
            <div className={` bg-slate-800 flex flex-col justify-between z-50 absolute top-0 left-0 overflow-y-hidden h-screen w-[90%] sm:w-[38%] ${menuIcon? "translate-x-0": "-translate-x-full"} transition-transform duration-1000 ease-in-out`}>
